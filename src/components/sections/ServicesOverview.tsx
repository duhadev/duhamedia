...
const tiers = [
  {
    ...
    who: "You're spending on paid ads, doing 25,000+ monthly sessions, and your campaigns aren't connected to conversion data. Your media buyer and your site operate in separate silos.",
    what: "A 12-week intensive covering a full marketing audit, UTM taxonomy rebuild, site CRO overhaul, and a campaign playbook your team can run independently. From week 13, a retainer runs the system and operates GrowthBook A/B tests against your traffic.",
    outcome: "Every ad dollar traceable to on-site behaviour. A documented system that works whether or not we're involved.",
    model: "From $15,000 intensive + from $1,500/mo retainer",
  ...
  },
  {
    ...
    accent: "#e82561",
    badge: "Most common",
    tagline: "Continuous heuristic CRO against a documented baseline.",
    who: "You have traffic — 10,000+ monthly sessions — but conversion rate is flat or unknown. You want to know what's actually stopping people from buying.",
    what: "Monthly heuristic CRO fixes from Shopify Analytics, Clarity, and GA4 data. A 90-day rolling roadmap updated each month. Monthly strategy call. Every fix documented before it ships, every result recorded against baseline. Backed by the Conversion Guarantee.",
    outcome: "A compounding CVR improvement — measured against your baseline every single month.",
    model: "From $5,000 setup + from $500/mo retainer",
  ...
  },
  {
    ...
    model: "One-time project · ~3 months · $500/mo dashboard retainer",

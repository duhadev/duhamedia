...
const NAV_LINKS: NavLink[] = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        desc: "12-week transformation for scaling brands ($300K–$1M+, 25,000+ monthly sessions). Paid attribution, GrowthBook A/B testing, always-on dashboard.",
      },
      {
        label: "Class B — CRO Core",
        href: "/services/class-b",
        desc: "Monthly heuristic CRO for Shopify stores with 10,000+ monthly sessions. Backed by the Conversion Guarantee.",
        featured: true,
      },
      {
        label: "Class C — Foundation",
        href: "/services/class-c",
        desc: "Conversion-ready Shopify site, engineered UX, Clarity + GA4 from day one. The minimum foundation for online success.",
      },
    ],
  },
  {
